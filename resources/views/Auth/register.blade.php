                                            ...
                                            <div class="row mb-3">
                                                <div class="col-md-6">
                                                    <div class="form-floating mb-3 mb-md-0">
                                                        ...
                                                        <label for="inputFirstName">surname name</label>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-5">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    ...
                                    <div class="card-body">
                                        <form method="POST" action="{{ route('webregister') }}">
                                            ...
                                            <div class="row mb-3">
                                                <div class="col-md-6">
                                                    <div class="form-floating mb-3 mb-md-0">
                                                        <input class="form-control" id="inputFirstName" type="text" name="user_firstname" placeholder="Enter your first name" />
                                                        <label for="inputFirstName">surname name</label>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-floating">
                                                        <input class="form-control" id="inputLastName" type="text" name="user_othernames" placeholder="Enter your last name" />
                                                        <label for="inputLastName">other names</label>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="card-footer text-center py-3">
                                        <div class="small"><a href="{{ route('login') }}">Account already exist? Login!</a></div>
                                    </div>
                                </div>
                            </div>
                        </div>
